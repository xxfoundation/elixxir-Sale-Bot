...
var rootCmd = &cobra.Command{
	Use:   "Sale",
	Short: "Runs the cMix Sale bot.",
	Long:  "The sale bot accepts messenger connections for sale registration.",
	Args:  cobra.NoArgs,
	Run: func(cmd *cobra.Command, args []string) {
		...
		saleUname, err := fact.NewFact(fact.Username, "xx Sale Registrar")
		if err != nil {
			jww.FATAL.Printf("Failed to create sale username fact: %+v", err)
		}
		me.Facts = append(me.Facts, saleUname)
		...
		rcb := func(requestor contact.Contact, msg string) {
			...
			payload := &sale.CMIXText{Text: intro}
